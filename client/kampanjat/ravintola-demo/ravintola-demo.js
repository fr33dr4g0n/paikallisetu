if (Meteor.isClient) {
    Template.ravintolademo_thankyou.helpers({
        'numero': function() {
            return Session.get('phoneNumber');
        }
    });

    Template.ravintolademo.events({
        'submit form': function(e) {
            ...
            if (validatePhone(recepientNumber)) {
                Meteor.call('lahetaTekstariravintolademo', recepientNumber);
                Router.go('/ravintolademo-thankyou');
            } else {
